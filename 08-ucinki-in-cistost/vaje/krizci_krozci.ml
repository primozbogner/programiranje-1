...
(* let is_full_row row = match row with
  | (Some of field, Some of field, Some of field) -> true
  | _ -> false *)

let is_full_row (r1, r2, r3) = if (r1 = None || r1 = None || r3 = None) then false else true
...
let winner_of_triple2 triple : player option = match triple with
